                        ...
                        <div class="field-group" style="margin-bottom:0">
                            ...
                            <div class="select-wrapper">
                                <select class="field-input" name="type" id="type" required>
                                    ...
                                    <option value="house" @selected(old('type', $property->type) == 'house')>
                                        Casa
                                    </option>
                                    ...
                                    <option value="land" @selected(old('type', $property->type) == 'land')>
                                        Terreno
                                    </option>

                                    <option value="commercial" @selected(old('type', $property->type) == 'commercial')>
                                        Local Comercial
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="prop-card" style="height:100%;box-sizing:border-box;">
                        ...
                        <div class="field-group" style="margin-bottom:0">
                            ...
                            <input type="text" class="field-input" name="address" id="address"
                                placeholder="Se detecta del mapa" required value="{{ old('address', $property->address) }}">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row-grid cols-2">
                            ...
                            <div class="field-group">
                                ...
                                <input type="number" class="field-input" name="price" id="price" placeholder="0.00" min="0"
                                    step="0.01" required value="{{ old('price', $property->price) }}">
                            </div>
                        </div>
                ...
                <select class="field-input" name="seller_id" id="seller_id">
                    ...
                    @foreach($vendedores as $vendedor)
                        <option value="{{ $vendedor->id }}" 
                            @selected(old('seller_id', $property->seller_id) == $vendedor->id)>
                            {{ $vendedor->name }}
                        </option>
                    @endforeach
                </select>
                        ...
                        <select class="field-input" name="client_id" id="client_id">
                            ...
                            @foreach($clientes as $cliente)
                                <option value="{{ $cliente->id }}" 
                                    @selected(old('client_id', $property->client_id) == $cliente->id)>
                                    {{ $cliente->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="prop-card">
                        ...
                        <div class="field-group" style="margin-bottom:0">
                            ...
                            <textarea 
                                ...
                                id="description" 
                                rows="4"
                                placeholder="Menciona amenidades, acabados, cercanía a puntos de interés..."
