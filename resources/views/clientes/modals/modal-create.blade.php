<div class="modal fade" id="modalNuevoCliente" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
                ...
                <div class="modal-header-inner">
                    <div class="modal-title-group">
                        ...
                        <div>
                            ...
                            <div class="modal-subtitle-text">Registra la información del propietario o cliente potencial</div>
                        </div>
                    </div>
            ...
            <form action="{{ route('clientes.store') }}" method="POST" id="formCliente" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-lg-6">
                            <div class="form-section">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <div class="field-group">
                                            <label class="field-label">Identificación Oficial</label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-section">
                                ...
                                <div class="field-group" style="margin-bottom:0;">
                                    <label class="field-label">Notas Internas <span style="color:var(--gray-300);font-weight:400;">(Opcional)</span></label>
